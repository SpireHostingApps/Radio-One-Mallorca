...
class NowPlayingViewController: UIViewController, WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.titleView = setTitle(title: currentStation.name, subtitle: currentStation.desc)
...
//        albumImageView.image = currentTrack.artworkImage
    ...
    @IBAction func shareButtonPressed(_ sender: UIButton) {
        ...
        let radioShoutout = "I'm listening to \(currentStation.name)"
